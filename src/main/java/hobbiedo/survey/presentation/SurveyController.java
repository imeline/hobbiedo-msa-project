...
import hobbiedo.survey.vo.response.GetHobbyQuestionVo;
...
public class SurveyController {
	...
	public ApiResponse<List<GetHobbyQuestionVo>> getHobbySurvey() {

		List<GetHobbySurveyDto> hobbySurveyQuestions = surveyService.getHobbySurveyQuestions();

		return ApiResponse.onSuccess(
			SuccessStatus.GET_HOBBY_SURVEY_SUCCESS,
			GetHobbyQuestionVo.hobbySurveyDtoToVo(hobbySurveyQuestions)
		);
	}
}
